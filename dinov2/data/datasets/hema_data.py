...
class HemaStandardDataset(VisionDataset):
    def __init__(
        ...
        *,
        ...
        if root_path.is_file() and root_path.suffix == '.txt':
            all_dataset_files = [root_path]
        elif root_path.is_dir():
            all_dataset_files = list(root_path.glob("*.txt"))
        ...
        if not self.patches:
            print(f"Warning: No valid dataset files/paths found in {root}.")
